        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('employer.event.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @if ($errors->has('place')) is-invalid @endif"
                                        name="place" value="{{ old('place') }}" placeholder="Enter Place" required>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="start_date" value="{{ old('start_date') }}" placeholder="Enter Post Code">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="end_date" value="{{ old('end_date') }}" placeholder="Enter Country">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="time"
                                        ...
                                        name="start_time" value="{{ old('start_time') }}" placeholder="Enter Bank Name">
