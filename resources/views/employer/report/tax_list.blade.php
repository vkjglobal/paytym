...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Tax Report</h6>
                    
                    <div class="float-right mb-3">
                          <button type="button" class="btn btn-primary btn-icon-text" onclick="window.location='{{route("employer.report.tax.export")}}'">
    ...
    <script type="text/javascript">
        ...
        (function($) {
            ...
            $('#filter_employment_period').on('click', function(e) {
                $.ajax({
                    type: "get",
                    url: "{{url('employer/report/tax/filter')}}",
                    async: true,
                    data: {
                        _token: token,
                        user: $('#user').val(),
