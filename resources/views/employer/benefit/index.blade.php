                            ...
                            <tbody>
                                @foreach ($benefit as $benefit)
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <input data-id="{{ $benefit->id }}" class="toggle-class" type="checkbox"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <!-- Edit button -->
                                                <a href="{{ route('employer.benefit.edit', $benefit->id) }}"
                                                ...
                                                <button type="button" class="text-danger"
                                                    onclick="event.preventDefault(); if(confirm('Are you sure to delete ?')){
                                                        document.getElementById('delete-data-{{ $benefit->id }}').submit();}"
                                                    data-toggle="tooltip" data-placement="top" title="Delete">
                                                    <i data-feather="trash"></i>
                                                </button>
                                                <form id="delete-data-{{ $benefit->id }}"
                                                    action="{{ route('employer.benefit.destroy', $benefit->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
