                          ...
                          <form class="forms-sample" method="POST" action="{{ route('employer.medical.update',$medical_detail->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="blood_grp" value="{{old('blood_grp', $medical_detail->blood_grp)}}" placeholder="Enter First Name" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="allergies" value="{{old('allergies', $medical_detail->allergies)}}" placeholder="Enter First Name" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="medical_issues" value="{{old('medical_issues', $medical_detail->medical_issues)}}" placeholder="Enter First Name" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="measurement" value="{{old('measurement', $medical_detail->measurement)}}" placeholder="Enter First Name" required>
