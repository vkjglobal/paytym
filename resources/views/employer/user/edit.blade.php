                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('last_name')) is-invalid @endif" name="last_name" value="{{ old('last_name',$user->last_name) }}" placeholder="Enter Last Name" required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('job_title')) is-invalid @endif" name="job_title" value="{{ old('job_title',$user->job_title) }}" placeholder="Enter Job Title" required>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('street')) is-invalid @endif" name="phone" value="{{ old('phone',$user->phone) }}" placeholder="Enter Phone No">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @if ($errors->has('city')) is-invalid @endif" name="date_of_birth" value="{{ old('date_of_birth',$user->date_of_birth) }}" placeholder="Enter Country">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('street')) is-invalid @endif" name="street" value="{{ old('street',$user->street) }}" placeholder="Enter Street Name">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('city')) is-invalid @endif" name="city" value="{{ old('city',$user->city) }}" placeholder="Enter City">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('postcode')) is-invalid @endif" name="postcode" value="{{ old('postcode',$user->postcode) }}" placeholder="Enter Post Code">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('tin')) is-invalid @endif" name="tin" value="{{ old('tin',$user->tin) }}" placeholder="Enter Tin">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('bank')) is-invalid @endif" name="bank" value="{{ old('bank', $user->bank) }}" placeholder="Enter Bank">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('bank_branch')) is-invalid @endif" name="bank_branch" value="{{ old('bank_branch', $user->bank_branch_name) }}" placeholder="Enter Bank Branch">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('account_number')) is-invalid @endif" name="account_number" value="{{ old('account_number',$user->account_number) }}" placeholder="Enter Account Number">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('licence_no')) is-invalid @endif" name="licence_no" value="{{ old('licence_no',$user->licence_no) }}" placeholder="Enter Licence No">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @if ($errors->has('licence_expiry_date')) is-invalid @endif" name="licence_expiry_date" value="{{ old('licence_expiry_date',$user->licence_expiry_date) }}" placeholder="Enter Licence Expiry Date">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if ($errors->has('passport_no')) is-invalid @endif" name="passport_no" value="{{ old('passport_no',$user->passport_no) }}" placeholder="Enter Passport No">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @if ($errors->has('passport_expiry_date')) is-invalid @endif" name="passport_expiry_date" value="{{ old('passport_expiry_date',$user->passport_expiry_date) }}" placeholder="Enter Passport Expiry Date">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @if ($errors->has('start_date')) is-invalid @endif" name="start_date" value="{{ old('start_date', $user->employment_start_date) }}" placeholder="Enter Image" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @if ($errors->has('end_date')) is-invalid @endif" name="end_date" value="{{ old('end_date',$user->employment_end_date) }}" placeholder="Enter Image">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @if ($errors->has('image')) is-invalid @endif" name="image" placeholder="Enter Image">
