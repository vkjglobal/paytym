        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('employer.leave-type.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="leavetype" value="{{ old('leavetype') }}" placeholder="Enter leave Type" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="num_days" value="{{ old('num_days') }}" placeholder="Enter no of days" required>
