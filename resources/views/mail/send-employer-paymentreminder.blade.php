                ...
                <table style="width: 500px; margin: 0 auto; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="text-align: left;">
                            ...
                            <br>
                            Your payment for previous month is pending and if the payment is not done before 8th of this month or within 48 hours, your account will be deactivated.
                            Please make the payment at the earliest inorder to avoid account deactivation.<br>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 15px;">
