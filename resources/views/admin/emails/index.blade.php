                            ...
                            <tbody>
                                @foreach ($emails as $email)
                                    <tr>
                                        ...
                                        <td>{{ $email->email }}</td>
                                     <!--    <td>
                                            <input data-id="{{ $email->id }}" class="toggle-class" type="checkbox"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <!-- Edit button -->
                                                <a href="{{ route('employer.emails.edit', $email->id) }}"
                                                ...
                                                <button type="button" class="text-danger"
                                                    onclick="event.preventDefault(); if(confirm('Are you sure to delete ?')){
                                                        document.getElementById('delete-data-{{ $email->id }}').submit();}"
                                                    data-toggle="tooltip" data-placement="top" title="Delete">
                                                    <i data-feather="trash"></i>
                                                </button>
                                                <form id="delete-data-{{ $email->id }}"
                                                    action="{{ route('employer.emails.destroy', $email->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
