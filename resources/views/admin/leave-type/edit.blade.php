        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.leave-type.update',$leave_type->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                                ...
                                <select class="form-control" class="form-control @if ($errors->has('country_id')) is-invalid @endif" name="country_id" value="{{ old('country_id') }}">
                                    ...
                                    <option value="{{$value['id']}}" @if ($value['id']==$leave_type->country_id)
                                        selected
