                    ...
                    <div class="col-md-4 mb-md-4 mb-3 d-flex">
                        <div class="card-about text-center  pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $employee_management->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $employee_management->content}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-md-4 mb-3 d-flex">
                        <div class="card-about text-center  pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $payroll_management->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $payroll_management->content}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-md-4 mb-3 d-flex">
                        <div class="card-about text-center  pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $deposit->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $deposit->content}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-md-4 mb-3 d-flex">
                        <div class="card-about text-center  pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $employee_management->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $employee_management->cms_type}}</p>
                                @endif
                            </div>
                        ...
                        <div class="card-about text-center  pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <p class="card-text pt-3 text-center">Manage and view payroll summaries, trends, comparisons, employee breakdowns and tax
                                    compliance reports at a click.</p>
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $analytics_report->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $analytics_report->cms_type}}</p>
                                @endif
                            </div>
                    ...
                    <div class="col-md-4 mb-md-4 mb-3 d-flex">
                        <div class="card-about text-center pb-3">
                            ...
                            <div class="card-body pt-3">
                                ...
                                @else
                                <h5 class="card-title pt-2 text-center">{{ $chat->cms_type}}</h5>
                                <p class="card-text pt-3 text-center">{{ $chat->cms_type}}</p>
